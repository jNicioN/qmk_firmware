...
select	@SoCiudadID	= convert(int, @Ciu_Numero)

if @SoCiudadID = @Ent_Cero begin
...
select	@SoCiudadID	= convert(int, @Ciu_Numero + @Ciu_Estado),
		@SoEstadoID	= convert(int, @Ciu_Estado)

insert into SOCIUDAD values (
	@SoCiudadID,	@Ciu_Numero,	@Ciu_Nombre,	@SoEstadoID,	@Ciu_Estado,
	@Ciu_CobRem,	@Ciu_Plaza,		@Ciu_ClaABM,	@Ciu_CoCNBV,	@NumTransac,

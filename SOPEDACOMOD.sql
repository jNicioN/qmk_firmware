...
** Fecha:		07/Ene/2016												****
** Help:		00801121												****
** Descripción:	Agregar parámetros @DaP_EsPEP, @DaP_EsPaPE y			****
**				@DaP_ParPEP												****
****************************************************************************
** Creó:		Rolando Bernal											****
** Fecha:		12/Nov/2015												****
...
update SOPEDACO set
	DaP_Firma	= @DaP_Firma,
	DaP_CaNuIn	= @DaP_CaNuIn,
	DaP_FuPuPe	= @DaP_FuPuPe,
	DaP_NoFaPe	= @DaP_NoFaPe,
	DaP_ApPaPe	= @DaP_ApPaPe,
	DaP_ApMaPe	= @DaP_ApMaPe,
	DaP_EntBan	= @DaP_EntBan,
	DaP_EsPEP	= @DaP_EsPEP,
	DaP_EsPaPE	= @DaP_EsPaPE,
	DaP_ParPEP	= @DaP_ParPEP,
	DaP_PaiNac	= @DaP_PaiNac,
	DaP_EntNac	= @DaP_EntNac,
	DaP_CoVeDi	= @DaP_CoVeDi,
	DaP_FolFid  = @DaP_FolFid,
	DaP_TipFid	= @DaP_TipFid,
	DaP_TiIdAd	= @DaP_TiIdAd,
	DaP_NuIdAd	= @DaP_NuIdAd,
	DaP_ExIdAd	= @DaP_ExIdAd,
	DaP_VeIdAd	= @DaP_VeIdAd,
...
if @@nestlevel = 1
	select	Err_Codigo	= '000000',
			Err_Mensaj	= 'Datos Complementarios de Persona Modificados'

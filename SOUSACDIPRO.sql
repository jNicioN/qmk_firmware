...
as
/****************************************************************************/
/* DESCRIPCION:	Borrado y un registro de tabla acceso directo (SOUSACDI)	**
**				y actualizacion de los indices mayores al borrado			*/
/****************************************************************************/
/* REFERENCIAS:																*/
/*****************************************************************************
...
exec SOUSACDIBAJ
	@Uad_Numero,	@Uad_Usuari,	@Uad_Pantal,	@Uad_Indice,	@NumTransac,
	@Transaccio,	@Usuario,		@FechaSis,		@SucOrigen,		@SucDestino,
	@Modulo

update SOUSACDI set
	Uad_Indice	= Uad_Indice - 1,

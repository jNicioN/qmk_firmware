...
/****************************************************************************
** Descripción:	 Consulta a Catalogo de Tipos de Correo					****
****************************************************************************
** Creó:			Norma Tijerina				****
** Fecha:		03-05-2017									****
** Help:		00946339										****
...
if @Tip_ConTip = @Con_Consul begin		/* Consultas */
	...
	if @Tip_ConCon = @Por_LlaPri begin	/* Consulta por llave principal */
		...
		select	Ctc_Numero,	Ctc_Nombre,	Ctc_Descri,	Ctc_Activo,	Ctc_Principal /*consulta por numero de Tipo de Correo*/
			from SOCATICO noholdlock
	...
	if @Tip_ConCon = @Por_LlaPri begin	/* Lista por llave principal */
		...
		select	Ctc_Numero,	Ctc_Nombre,	Ctc_Descri,	Ctc_Activo,	Ctc_Principal
			from SOCATICO noholdlock

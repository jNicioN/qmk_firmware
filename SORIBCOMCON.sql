create procedure SORIBCOMCON (
 ...
 as 
/****************************************************************/
/* DESCRIPCION: Consulta de registros de Competidores de RIB	*/
/****************************************************************/
...
if @Tip_ConTip	= @Str_C begin /* 'C': Consulta */
   if @Tip_ConCon = @Str_Uno begin		/* C1 */
     select 
          Ric_Numero,    Ric_NumRib,    Ric_Nombre,    Ric_Ubicac,    Ric_Ventaj, 
          Ric_Desven,    Ric_Activo 

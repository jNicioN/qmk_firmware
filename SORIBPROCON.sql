create procedure SORIBPROCON (
 ...
 as 
/****************************************************************/
/* DESCRIPCION: Consulta de registros de Proveedores de RIB		*/
/****************************************************************/
...
if @Tip_ConTip	= @Str_C begin /* 'C': Consulta */
   if @Tip_ConCon = @Str_Uno begin		/* C1 */
     select 
          Rip_Numero,    Rip_NumRib,    Rip_Nombre,    Rip_Filial,    Rip_PorCom, 
          Rip_Antigu,    Rip_Insumo,    Rip_Plazo,    Rip_TipPro,     Rip_Varios,
		  Rip_Activo 

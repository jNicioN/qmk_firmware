...
/****************************************************************/
/* DESCRIPCION: Actualizacion de Reporte de Informacion Basica	*/
/****************************************************************/
...
declare @Tip_ActualA char(1),		/* Caracter A */
		@Tip_ActualB char(1),		/* Caracter B */
		@Tip_ActualC char(1),		/* Caracter C */
...
else if @Tip_Actual = @Tip_ActualB begin
	update SORIB set
		Rib_TipRib	= @Rib_TipRib,
		NumTransac = @NumTransac,
		Transaccio = @Transaccio, 
...
else if @Tip_Actual = @Tip_ActualC begin
	update SORIB set

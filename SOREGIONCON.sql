...
** Help Desk:	1212881 										****
********************************************************************
** Modificion:	Erick Gloria		   							****
** Fecha:		27/03/2018									    ****
** Descripcion:	Se agrego campo Reg_SegNum a consulta y asignacion de constantes			****
** Help Desk:	1093350											****
********************************************************************
** Modificion:	Daniel Salas [CDIS]   							****
** Fecha:		24/Julio/2017									****
** Descripcion:	Se agrego consulta por descripcion 				****
** Help Desk:	1004978											****
********************************************************************
...
declare	@Tip_ConTip	char(1),        /* Tipo de consulta C*/
		@Tip_ConCon	char(1)         /* Valor de consulta*/
...
if @Tip_ConTip	= @Str_ConsC begin			/* 'C': Consulta */
	...
	if @Tip_ConCon	= @Str_Cons3 begin		/* C3 */
	    select reg.Reg_Numero,	reg.Reg_Descri,	reg.Reg_Status,	seg.Seg_Nombre, reg.Reg_SegNum
			from SOREGION reg noholdlock
			inner join SOSEGMEN seg noholdlock on (seg.Seg_Numero = reg.Reg_SegNum )
	end
	...
	if @Tip_ConCon	= @Str_Cons3 begin		/* L3 */
		select	reg.Reg_Numero,	reg.Reg_Descri,	reg.Reg_Status,	seg.Seg_Nombre, reg.Reg_SegNum
			from SOREGION reg noholdlock
			inner join SOSEGMEN seg noholdlock on (seg.Seg_Numero = reg.Reg_SegNum )
